...
% -
    ...
    DATASET_METADATA = ...
        {'mvtName',             'Name of the movement.',                ''; ...
         ...
         ...
         'acquisitionConditions','Condition of acquisition, mainlyRoI and ''barillet'' level', ...
                                                                        ''; ...
    ...
    for movementId = 1 : N_MOVEMENTS,
        for barilletLevel = 1 : N_BARILLET_LEVELS,
            ...
            fileId = {sprintf('ML0156-%02dc', movementId)};
            acquisitionCondition = {fileName(12:18)};
            NewDataset = dataset(fileId, 1800, POINTAGE, BALANCIER_AMPLITUDE_ARRAY(iFile), ...
                                 acquisitionCondition, timestamp, TIME_BASE_CORRECTION_FACTOR, ...
