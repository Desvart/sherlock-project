% PANDAS script (PANDAS: Precise Annotation for Non-Deterministic Annoying Signals)
% 
% Original author (Vers. 0.0.1) : PB
% Adaptation + optimisation     : Pitch
% Vers. 0.0.2
% 2012.04.03 - 2012.??.??
