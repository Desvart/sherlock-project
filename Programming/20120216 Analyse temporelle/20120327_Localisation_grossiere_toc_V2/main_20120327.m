...
%%% tocs
rawTocThresholdDb   = noiseLevelDb / 3; % -20 dB
...
if plotFlag,
    ...
    energyDbNoiseClipped(energyDb < noiseLevelDb) = noiseLevelDb;
    ...
    xlabel('Time [ms]');
    ylabel('Energy [dB]');
    title(sprintf('Signal energy (noise clipped < %2.0f dB, threshold = 1/3 noiselevel = %2.0f dB)', noiseLevelDb, rawTocThresholdDb));
