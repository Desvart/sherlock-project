...
for i = 1:crossvalidation_loop,
    ...
    % Start Training
	[m, C, w, v_PCA, d_PCA, v_LDA, d_LDA, totmean, totstd] = ... 
        training(trainfiles, Train_Sig_Nbr, Gaussian_Nbr, PCA_dim, LDA_dim, SNR_training);
    ...
    % Start Testing
    [membership, maxlogl, cert] = testing(m, C, w, testfiles, Test_Sig_Nbr, ...
...
rmpath(genpath('../reco_AD/toolboxes/'));
