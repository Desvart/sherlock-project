...
for i=1:iterations,
   ...
   %Training
	...
	%save training.mat m c v d;
   
   %Testing
 	%load training;
   [membership,meancert,reject,testsnr(i)]=testing(net,testfiles,NbreSigTest,v,d,vsep,dsep,M,totmean,totvar,noiselevel);
