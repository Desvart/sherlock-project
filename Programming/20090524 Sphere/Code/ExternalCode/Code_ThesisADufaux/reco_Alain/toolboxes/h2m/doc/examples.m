% This file provides simple examples of the use of h2m functions on low-
% dimensional synthetic data for the three types of models :
%   1. Fully connected HMM
%   2. Left-right HMM
%   3. Mixture model
%
...
% EM iterations
for i = 1:n_it
  [alpha, beta, logscale, dens] = hmm_fb(X, A_, pi0_, mu_, Sigma_);
...
% [A_,pi0_,mu_,Sigma_,logl] = hmm(X,A,pi0,mu,Sigma,n_it);
% Plot
clf;
gauselps(mu_,Sigma_);
hold on;
