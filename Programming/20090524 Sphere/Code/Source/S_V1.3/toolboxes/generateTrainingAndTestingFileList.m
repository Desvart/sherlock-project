...
function [trainingFile, testingFile] = generateFileList(trainingStrategy, class, database)
                    
                    % persistent
                    
    %%% Load inputs
    nbClass = class.nbClass;
    nbFile = class.nbFile;
    nbFilePerClass = class.nbFilePerClass;
    ...
    switch trainingStrategy,
        ...
        case 'fiftyFifty',
            ...
            for i = 1 : nbClass, 
                trainingFileIndexPerClass{i} = randperm(nbFilePerClass(i)); % Random determination
                trainingFileIndexPerClass{i} = 1 : nbFilePerClass(i);       % No random determination
            end
