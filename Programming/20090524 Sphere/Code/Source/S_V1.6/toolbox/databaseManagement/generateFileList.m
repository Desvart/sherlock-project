...
function [trainingFilePath, testingFilePath] = generateNormalFileList(trainingStrategy, filePath)
    ...
    for i = 1 : nbClass,
        ...
        trainingFileIndex(firstTrainingIndex:lastTrainingIndex) = ...
                                       randIndexForThisClass(1:nbTrainingFilePerClass(i));
                                   
        firstTestingIndex = lastTestingIndex + 1;
        lastTestingIndex = firstTestingIndex + nbTestingFilePerClass(i) - 1;
        
        testingFileIndex(firstTestingIndex:lastTestingIndex)  = ...
                                   randIndexForThisClass(nbTrainingFilePerClass(i)+1:end);
