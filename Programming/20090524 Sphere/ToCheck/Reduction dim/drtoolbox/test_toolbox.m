...
% University California, San Diego / Delft University of Technology
    ...
    % Test all dimension reduction techniques
    disp('Testing dimensionality reduction techniques...');
    techniques = {'PCA', 'LDA', 'MDS', 'ProbPCA', 'FactorAnalysis', 'GPLVM', 'Sammon', 'Isomap', ...
        ...
        'LLTSA', 'SPE', 'AutoEncoderRBM', 'AutoEncoderEA', 'LLC', 'ManifoldChart', 'CFA', 'NCA', 'MCML'};
    for i=1:length(techniques)
        try
