...
% University California, San Diego / Delft University of Technologyy
...
%             checkgrad('nca_lin_grad', A(:), 1e-7, cur_X, cur_labels, no_dims, no_labels, lambda)
            [A, f] = minimize(A(:), 'nca_lin_grad', 5, cur_X, cur_labels, no_dims, no_labels, lambda);
