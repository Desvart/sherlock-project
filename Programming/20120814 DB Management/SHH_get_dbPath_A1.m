...
%
% Algorithm :
%   1. Extract folder names
%   2. Extract version number from folder names
%   3. Compare all version number to desired version number and outputs the correct folder path

% Project   : Sherlock Holmes - DB Management
% File vers.: Alpha 1 (2012.08.16)
%
