...
[matObj, nFileSelected] = SHH_get_matObj_A1();
...
fileSelectionList = [];
[matObj, nFileSelected] = SHH_get_matObj_A1(fileSelectionList);
...
test = (matObj.signal(1, 2*matObj.fs) - 1.7624e-4 < 1e-8);
if test == false, error('Test failed.'); end
...
[matObj, nFileSelected] = SHH_get_matObj_A1(fileSelectionList, DATABASEPATH);
...
fileSelectionList = {[], [], [], [], [11, 12], [], [], [], [5]};
[matObj, nFileSelected] = SHH_get_matObj_A1(fileSelectionList, '../ARH_DB4_2/');
...
fileSelectionList = {[], [], [], [], [11, 12], [], [], [], [5]};
[matObj, nFileSelected] = SHH_get_matObj_A1(fileSelectionList, '../ARH_DB4_2/', true);
