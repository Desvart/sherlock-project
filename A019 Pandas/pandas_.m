function [degagementStartIdxArray, chuteStartIdxArray] = ...
                                       pandas_(signal, stdWinSize, stdRatioThreshold, distThreshold)
...
% Project : Sherlock Holmes - Pandas (Alpha 3.3)
% 2012.08.10 - 2013.01.17
%
...
% Log
% 2013.01.21    - Test sur l'int�gralit� de la base de donn�es ViSo "barillet". R�sultat OK. => 
%                 passage du script en Beta 1.0 (= A3.3)
% 2013.01.17    - Add a function (PANDAS_remove_middle_pulse) to remove behavior that detect a third 
%                 pulse between "d�gagement" and "chute" (the "UFO" one).
%               - Modify stdRatioThreshold default value from 20 to 15 (adaptation for signal 
%                 ML03_R00_B06_N01).
% 2013.01.15    Fixed bug that detect local double peaks in hard thresholding.
% 2013.01.10    File restructuration.
% 2012.08.10	File creation.
