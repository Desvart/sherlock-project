...
%% Load signal
databasePath = '.\\Ongoing\ABP011_Sherlock_Holmes\Database\Sounds\20111100_ARH\ARH_DB4_2\';

addpath(databasePath);
matObj = SHH_get_matObj([1,1], databasePath);
fs = matObj{1}.fs;
signal = matObj{1}.signal(1, 1:fs);
...
% contains std dev
std_vec2= movingstd(signal,width2,'backward');

% contains std dev
stf_vec2= movingstd(signal,width2,'forward');
