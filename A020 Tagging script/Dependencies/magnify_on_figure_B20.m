...
%---------------|---------------|-------------------|---------------------------------------
%   1.0         |   28/11/2009  |   DF    |   First version
%   1.1         |   29/11/2009  |   DF    |   Added link from magnifier to secondary axes
%   1.2         |   30/11/2009  |   DF    |   Keyboard support added
%   1.3         |   01/12/2009  |   DF    |   Properties added
%   1.4         |   02/12/2009  |   DF    |   Manual mode supported
%   1.5         |   03/12/2009  |   DF    |   New link style added ('edges')
%   1.6         |   03/12/2009  |   DF    |   Bug solved in display of link style 'edges'
%   1.7         |   04/12/2009  |   DF    |   Target axes selection added
%   1.8         |   07/12/2009  |   DF    |   Solved bug when any of the axes are reversed.
%   1.9         |   08/12/2009  |   DF    |   Adapted to work under all axes modes (tight, square, image, ...)
%   1.10        |   08/12/2009  |   DF    |   Added frozenZoomAspectRatio zoom mode, useful for images
%   1.11        |   08/12/2009  |   DF    |   Solved bug when axes contain other than 'line' or 'image' objects
%   1.12        |   05/01/2010  |   DF    |   Added support to multiple instances
%   1.13        |   05/01/2010  |   DF    |   Added 'delete' functionality
%   1.14        |   05/01/2010  |   DF    |   Solved bug when initial positions for secondary axes and/or magnifier are specified
%   1.15        |   07/01/2010  |   DF    |   Solved bug when resizing window
%   1.16        |   07/01/2010  |   DF    |   Improved documentation
%   1.17        |   28/03/2010  |   DF    |   Added tool identifications feature
%   A0.1.18 (B2.0)| 10/01/2013  |   Pitch     |   Various modification for Sherlock Holmes Project
%

function [magnifierHandle, secondaryAxesHandle] = magnify_on_figure_B20(varargin)
...
%                );
    ...
    if outputObjectExpected == true
        ...
        if nargout == 2,
            magnifierHandle = appDataStruct.magnifierHandle;
            secondaryAxesHandle = appDataStruct.secondaryAxesHandle;
        end
    end
...
function refreshSecondaryAxisLimits()
    ...
    for iChild = 1:length(childHandle)
        if strcmpi(get(childHandle(iChild), 'Type'), 'line')
            set(childHandle(iChild), 'LineWidth', 1);
        end
