...
%
% See also SHH_pandas and magnify_on_figure

% Project : Sherlock Holmes - TagThemAll
%   Build   : Matlab R2012b (8.0.0.783) x64 - Windows 7 x64

% History
% 1.1.b3.0403   Fix typo
% 1.1.b2.0210   Update documentation and fix typo
% 1.1.b1.0106   Change input and ouput destination
...
% 1.0.b0.0101	First functionnal version
% 0.0.a0.0000	File creation (2013.05.30)
...
for iFile = 1 : nFiles,
    ...
    while true,
        ...
        %%% User interface
        dispStr1    = 'Are unlocking start index right ? [y, [winSize stdThresh distThresh tocDuration]]\n';
